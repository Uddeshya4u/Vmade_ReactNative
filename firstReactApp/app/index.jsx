...
export default function App() {
  ...
  return (
    // Using safe area view so the view takes the size of any devices (for full screen views)
      ...
      >
        <View className='w-full min-h-[85vh] items-center px-4 justify-center'>
          ...
          <Text className='font-pregular mt-7 text-gray-100 text-center text-lg'>
            Join in to embark on joiurney with limitless exploration where your
